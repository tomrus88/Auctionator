...
function Atr_BasicOptionsFrame_Save (frame)
  ...
  local origValues = zc.msg_str (AUCTIONATOR_ENABLE_ALT, AUCTIONATOR_QUICK_SCAN_PAGES, AUCTIONATOR_SHOW_ST_PRICE, AUCTIONATOR_DEFTAB, AUCTIONATOR_DEF_DURATION);

  AUCTIONATOR_ENABLE_ALT    = zc.BoolToNum(AuctionatorOption_Enable_Alt_CB:GetChecked ());
  AUCTIONATOR_QUICK_SCAN_PAGES = AuctionatorOption_Quick_Scan_Pages:GetNumber();
  ...
  local newValues = zc.msg_str (AUCTIONATOR_ENABLE_ALT, AUCTIONATOR_QUICK_SCAN_PAGES, AUCTIONATOR_SHOW_ST_PRICE, AUCTIONATOR_DEFTAB, AUCTIONATOR_DEF_DURATION);
...
function Atr_SetupBasicOptionsFrame()
  ...
  AuctionatorOption_Quick_Scan_Pages:SetText(AUCTIONATOR_QUICK_SCAN_PAGES);
